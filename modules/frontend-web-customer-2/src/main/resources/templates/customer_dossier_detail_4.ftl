	...
	<div class="box">
		...
		<div class="row-header align-middle">
			...
			<div class="pull-right group-icons">
				...
				<a class="" id="btn-sendReissue-dossier-header" data-bind="value : lockState"><i class="fa fa-paper-plane"></i> Yêu cầu sửa giấy chứng nhận</a>
					...
					<div id="unpaid">
						<div class="row MB10">
							<div class="col-sm-12">
								...
								<button class="btn btn-sm btn-border-color text-light-blue" id="dossier-payment-viewpdf" data-bind="attr : {data-pk : referenceUidPayment}">Phiếu thông báo phí, lệ phí</button>
							</div>
						</div>
...
<div class="button-row MT20">
	...
	<a class="btn btn-active" id="btn-sendReissue-dossier-footer" data-bind="value : correctingDate"><i class="fa fa-paper-plane"></i> Yêu cầu sửa giấy chứng nhận</a>
