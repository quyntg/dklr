<#if (Request)??>
	...
	<#assign dossierNo = (Request.dossierNo)!>
	<#assign methodOfIssue = (Request.methodOfIssue)!>
	<#assign dnKiemTra = (Request.dnKiemTra)!>
	<#assign dnGiamSat = (Request.dnGiamSat)!>
	<#assign dnHuy = (Request.dnHuy)!>
	<#assign dnTraHuy = (Request.dnTraHuy)!>
	<#assign issueType = (Request.issueType)!>
