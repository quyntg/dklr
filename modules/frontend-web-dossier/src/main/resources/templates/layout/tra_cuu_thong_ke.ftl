                      ...
                      <tr>
                        <td v-for="(itemHeader, index) in headersTraCuu" class="text-xs-center">
                          ...
                          <div v-else-if="itemHeader['display'] === 'action'">
                            ...
                            <v-chip label outline color="blue" v-if="checkMtCore(props.item)" @click="xemGiayChungNhan(props.item)">
                                <v-icon
                                    size="17"
                                    style="font-size: 15px;"
                                    :color="(props.item['vr_VehicleTypeCertificate'] && props.item['vr_VehicleTypeCertificate']['deliverableFileEntryid'] != '0') ? 'green' : 'red'"
                                    >
                                    {{(props.item['vr_VehicleTypeCertificate'] && props.item['vr_VehicleTypeCertificate']['deliverableFileEntryid'] != '0') ? 'done' : 'cancel'}}
                                </v-icon>
                                Xem GCN
                            </v-chip> <br>
