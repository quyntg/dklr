<template>
  <!-- Dùng cho kiểm tra thiết bị phanh, đèn pha -->
  <div>
   ...
   <tbody>
      ...
      <tr :style="{background: checkColorCop(thietBiKiemTra['resultStatus'])}">
        ...
        <td class="text-xs-center">
          <input type="radio" name="hoatdong" id="hoatdong" value="1" v-model="thietBiKiemTra['status']">
          <label class="mr-3" for="hoatdong">Hoạt động</label>

          <input type="radio" name="hoatdong" id="khonghd" value="2" v-model="thietBiKiemTra['status']">
