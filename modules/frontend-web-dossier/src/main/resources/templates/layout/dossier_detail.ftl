				...
				<v-card v-if="stepModel != null">
                    ...
                    <div v-else>
                    	...
                    	<v-expansion-panel class="my-0 expansion__list_style">
                            ...
                            <div slot="header" @click.prevent="showAlpacaJSFORM(item, stepModel['processActionId'])">{{i + 1}}. {{item.partName}} <small v-if="item.eform">( Form trực tuyến )</small> </div>
                            ...
                            <div class="text-right pr-4 pt-2" v-if="item.eform">
                            	<v-fab-transition>
                            ...
                            <div v-if="item['dossierPartId'] === 288 && item['partNo'] === 'KQ4'" id="formCOP" :referenceUid="item['referenceUid']" :processActionId="stepModel['processActionId']">
                            	<#include "formCop.ftl">
                            </div>
                            ...
                            <div v-else-if="(item['partNo'] === 'KQ6' || item['partNo'] === 'KQ4') && item['dossierTemplateNo'] === 'TT302011BGTVTCPPXCG'" id="bbKiemTraGiamSatDotXuat" :referenceUid="item['referenceUid']" :processActionId="stepModel['processActionId']">
