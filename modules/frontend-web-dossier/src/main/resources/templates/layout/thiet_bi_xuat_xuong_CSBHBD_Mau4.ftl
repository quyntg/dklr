  ...
  <div>
    <v-layout row wrap class="ml-0">
      ...
      <v-flex xs12 sm9>
        <v-text-field
          class="my-0 py-0"
          v-model="thietBiKiemTra['dossierNo']"
          readonly
        ></v-text-field>
      </v-flex>
    ...
    <table style="width: 100%; border-collapse: collapse;" border="1" class="ftable" v-if="detailCSBHBD['thiet_bi_xuat_xuong'] && detailCSBHBD['thiet_bi_xuat_xuong']['length']">
    <thead>
      <tr>
       <th class="text-xs-center" rowspan="2" style="width: 3%">TT</th>
       <th class="text-xs-center" rowspan="2">Hạng mục kiểm tra</th>
       <th class="text-xs-center" rowspan="2" colspan="2">Thông số chuẩn</th>
       <th class="text-xs-center" colspan="2">Thông số đo</th>
   ...
   <tbody>
      ...
      <tr>
        ...
        <td class="pl-2" rowspan="5">Bàn trượt phải</td>
      ...
      <tr>
        <td class="pl-2" rowspan="5">Bàn trượt trái</td>
        <td :style="{background: checkColorCop(thietBiKiemTra['resultTest'][5]['result'])}">
          <div style="display: flex;">
            <v-text-field
            style="width: 70%"
        ...
        <td class="text-xs-center" :style="{background: checkColorCop(thietBiKiemTra['resultTest'][5]['result'])}" @click="calPointCop()">
          <span v-for="(itemKq, indexKq) in kqThietBi" class="text-xs-center">
      ...
      <tr :style="{background: checkColorCop(thietBiKiemTra['resultTest'][6]['result'])}">
        <td>
          <div style="display: flex;">
            ...
            class="my-0 py-0"
            v-model="thietBiKiemTra['resultTest'][6]['standardParameters']"
            ></v-text-field>
            <span class="pt-2">{{donVi}}</span>
          </div>
        </td>
        <td>
          <div style="display: flex;">
            <v-text-field
              class="py-0 my-0"
              v-model="thietBiKiemTra['resultTest'][6]['resultMeasurementLeft']"
            ></v-text-field>
          </div>
        </td>
        <td>
          <div style="display: flex;">
            <v-text-field
              class="py-0 my-0"
              v-model="thietBiKiemTra['resultTest'][6]['resultMeasurementRight']"
            ></v-text-field>
          </div>
        </td>
        <td class="text-xs-center" @click="calPointCop()">
      ...
      <tr :style="{background: checkColorCop(thietBiKiemTra['resultTest'][7]['result'])}">
        <td>
          <div style="display: flex;">
            ...
            class="my-0 py-0"
            v-model="thietBiKiemTra['resultTest'][7]['standardParameters']"
            ></v-text-field>
            <span class="pt-2">{{donVi}}</span>
          </div>
        </td>
        <td>
          <div style="display: flex;">
            <v-text-field
              class="py-0 my-0"
              v-model="thietBiKiemTra['resultTest'][7]['resultMeasurementLeft']"
            ></v-text-field>
          </div>
        </td>
        <td>
          <div style="display: flex;">
            <v-text-field
              class="py-0 my-0"
              v-model="thietBiKiemTra['resultTest'][7]['resultMeasurementRight']"
            ></v-text-field>
          </div>
        </td>
        <td class="text-xs-center" @click="calPointCop()">
      ...
      <tr :style="{background: checkColorCop(thietBiKiemTra['resultTest'][8]['result'])}">
        <td>
          <div style="display: flex;">
            ...
            class="my-0 py-0"
            v-model="thietBiKiemTra['resultTest'][8]['standardParameters']"
            ></v-text-field>
            <span class="pt-2">{{donVi}}</span>
          </div>
        </td>
        <td>
          <div style="display: flex;">
            <v-text-field
              class="py-0 my-0"
              v-model="thietBiKiemTra['resultTest'][8]['resultMeasurementLeft']"
            ></v-text-field>
          </div>
        </td>
        <td>
          <div style="display: flex;">
            <v-text-field
              class="py-0 my-0"
              v-model="thietBiKiemTra['resultTest'][8]['resultMeasurementRight']"
            ></v-text-field>
          </div>
        </td>
        <td class="text-xs-center" @click="calPointCop()">
      ...
      <tr :style="{background: checkColorCop(thietBiKiemTra['resultTest'][9]['result'])}">
        <td>
          <div style="display: flex;">
            ...
            class="my-0 py-0"
            v-model="thietBiKiemTra['resultTest'][9]['standardParameters']"
            ></v-text-field>
            <span class="pt-2">{{donVi}}</span>
          </div>
        </td>
        <td>
          <div style="display: flex;">
            <v-text-field
              class="py-0 my-0"
              v-model="thietBiKiemTra['resultTest'][9]['resultMeasurementLeft']"
            ></v-text-field>
          </div>
        </td>
        <td>
          <div style="display: flex;">
            <v-text-field
              class="py-0 my-0"
              v-model="thietBiKiemTra['resultTest'][9]['resultMeasurementRight']"
            ></v-text-field>
          </div>
        </td>
        <td class="text-xs-center" @click="calPointCop()">
