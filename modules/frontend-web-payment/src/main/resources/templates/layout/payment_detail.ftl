	...
	<div v-if="detailPage" style="width: 100%;">
		<div class="row-header">
			...
			<div class="flex xs3 text-left">
				<v-btn class="my-0" flat @click.prevent.stop="paymentCapLai(detailModel.dossierId)"  v-show="detailModel.paymentStatus == 2">
					<v-icon>payment</v-icon>
					Cấp lại HĐĐT
				</v-btn>
			</div>
			
			<div class="flex xs2 text-right">
