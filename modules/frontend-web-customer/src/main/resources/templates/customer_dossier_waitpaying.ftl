							...
							<div id="unpaid">
								<div class="row MB10">
									<div class="col-sm-12">
										...
										<button class="btn btn-sm btn-border-color text-light-blue" onclick="" id="dossier-payment-viewpdf" data-bind="attr : {data-pk : referenceUid}">Phiếu thông báo phí, lệ phí</button>
									</div>
								</div>
