...
<script type="text/javascript">
		...
		$("#serverconfigs_list_view").kendoListView({
			...
			change: function() {
				...
				loadserverconfigsDetail(dataItem['serverConfigId'], dataItem['serverName'], dataItem['serverNo'], dataItem['protocol'], dataItem['configs']);
				deleteServerconfigs();
				$("#serverconfigs_pager .k-link").css({"border-radius":"0","border-color":"#ddd","height":"27px","margin-right":"0px"})
			}
		});
...
// ---------------------
	  var loadserverconfigsDetail = function(serverconfigId, serverName, serverNo, protocol, configs){
